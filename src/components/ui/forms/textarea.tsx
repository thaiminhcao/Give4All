    ...
    <div className={cn('text-xs sm:text-sm', className)}>
      <label>
        ...
        <textarea
          ...
          {...props}
          className={cn(
            'mt-1 block h-24 w-full rounded-md border border-blue-100 bg-white px-4 py-3 text-sm placeholder-gray-400 transition-shadow duration-200  invalid:border-red-500 invalid:text-red-600 focus:border-blue-200 focus:outline-none focus:ring-1 focus:ring-gray-900 focus:invalid:border-red-500 focus:invalid:ring-red-500 disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500 dark:border-gray-700 dark:bg-light-dark dark:text-gray-100 dark:focus:border-gray-600 dark:focus:ring-gray-600 sm:h-28 sm:rounded-lg',
            inputClassName
          )}
        />
      </label>
