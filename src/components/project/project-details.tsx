...
export default function ProjectDetails() {
  ...
  console.log(address)
  const getProject =useContractCalls(["title", "description", "imageURL", "raised", "expiresAt", "status"], address, "project")
  ...
  const title = getProject[0].data[0].result;
  const description = getProject[1].data[0].result;
  const imageURL = getProject[2].data[0].result;
  const raised = getProject[3].data[0].result;
  const expiresAt = getProject[4].data[0].result;
      ...
      <div className="pt-8 flex-nowrap justify-items-start w-full">
        <div className="flex flex-nowrap ">
          ...
          <div className="w-3/5 p-5 pt-4 xs:p-6 xs:pt-5 space-y-4 ml-40">
            ...
            <div className="w-96 text-black text-4xl font-semibold">{title}</div>
            ...
            <div className="flex">
              ...
              <h1 className="w-32 text-black text-xl font-semibold">{raised.toString()}</h1>
            </div>
